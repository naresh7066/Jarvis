...
import pywhatkit     #pip install opencv-python
...
# To read PDF
def pdf_reader():
    book = open("E:\\Vrushali Project\\JARVIS FULL PROJECT\\kahani.pdf", 'rb')
...
class MainThread(QThread):
    ...
    def TaskExecution(self):
        ...
        while True:
            ...
            elif "cmd" in self.query:
                os.system("start cmd")



            elif "play music" in self.query:
                music_dir = "E:\\NEW MP3 SONG\project songs"
            ...
            #     speak("message has been sent")
                ...
                pywhatkit.playonyt("shri hari stostram")
            ...
            elif "tell me news" in self.query or "tell me today news" in self.query:
            ...
            elif "read pdf" in self.query or "open pdf" in self.query:
                pdf_reader()
...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie("F:\\Vrushali Project\\ironman.gif")
        self.ui.ui.setMovie(self.ui.movie)
        self.ui.movie.start()
        timer = QTimer(self)
        timer.timeout.connect(self.showTime)
        timer.start(1000)
        startExecution.start()
        self.ui.movie = QtGui.QMovie("F:\\Vrushali Project\\jarvis loading.gif")
